...
setup(
    ...
    install_requires=[
        "adb-shell>=0.4.0",
        "pure-python-adb @ git+https://github.com/CloCkWeRX/pure-python-adb@v0.3.0.pre",  # This will change to https://github.com/spm5065/pure-python-adb when a tag is available
    ],
